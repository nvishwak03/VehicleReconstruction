...
from moviepy.video.io.VideoFileClip import VideoFileClip
 # If you’ve modularized it

# Optional: If your lane_finding_pipeline is in the same file, just define it above

# Path to input video
input_path = "test_videos/solidWhiteRight.mp4"
# Output video path
output_path = "solidWhiteRight_output.mp4"

# Load the video clip
clip = VideoFileClip(input_path)

# Apply lane detection pipeline to each frame
