...
# Clone the repo (only once; comment this after cloning)
# subprocess.run(['git', 'clone', 'https://github.com/udacity/CarND-LaneLines-P1.git'])

# # Example directory traversal
# for dirname, _, filenames in os.walk('CarND-LaneLines-P1'):
